...
need_space = 30000000 - (total_space - used_space)

print()
print("The smallest directory to delete and free up space for the update is:")
print([(x, truth[x]) for x in truth if truth[x] >= need_space])
print(min([(x, truth[x]) for x in truth if truth[x] >= need_space], key = lambda t: t[1]))
